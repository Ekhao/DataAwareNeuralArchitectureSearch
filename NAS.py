...
class SearchSpace():
    def __init__(self) -> None:
        self.input_search_space = self.search_space_gen([48000, 24000, 12000, 6000, 3000, 1500, 750, 325],["spectrogram", "mfe", "mfcc"],[32, 16, 8, 4, 2])
        self.model_layer_search_space = self.search_space_gen([8,16,32,64,128],["relu", "tanh", "sigmoid", "elu"])
