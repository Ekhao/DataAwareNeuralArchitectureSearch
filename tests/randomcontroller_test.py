    ...
    def test_combination_function(self):
        random_controller = randomcontroller.RandomController(
            search_space=searchspace.SearchSpace((
                [1, 2, 3, 4, 5, 6], ["a", "b", "c"]), ([48000, 24000, 12000, 6000, 3000, 1500, 750, 325], ["spectrogram", "mel-spectrogram", "mfcc"])), seed=41)
        num_combinations = len(
            random_controller.search_space.model_layer_search_space)
