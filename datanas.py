...
def main():
    ...
    argparser.add_argument(
        "-c",
        "--controller",
        help='The controller to use to direct the search. Also known as search strategy. Supported options are "evolution" and "random".',
        choices=["evolution", "random"],
    )
    argparser.add_argument(
        "-i",
        "--initialization",
        help='How to initialize the first generation of models for the "evolution" controller. Supported options are "trivial" and "random". Does nothing if paired with the "random" controller.',
    ...
    argparser.add_argument(
        "-ps",
        "--population_size",
        help="The population size to use for the evolutionary controller. This argument is ignored if the randomcontroller is used.",
        type=int,
    )
    argparser.add_argument(
        "-ur",
        "--population_update_ratio",
        help="The ratio of the population to be discarded and regenerated when the population is updated. This argument is ignored if the random controller is used.",
        type=float,
    )
    argparser.add_argument(
        "-cr",
        "--crossover_ratio",
        help="The ratio of the updated population to be generated by crossover. The rest of the updated population is generated by mutations. This argument is ignored if the random controller is used.",
        type=float,
    )
